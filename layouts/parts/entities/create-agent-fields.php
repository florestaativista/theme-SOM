...
<entity-terms :entity="entity" hide-required :editable="true" :classes="areaClasses" taxonomy='funcao_musica' title="<?php i::esc_attr_e("Função na música") ?>"></entity-terms>
